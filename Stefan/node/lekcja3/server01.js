...
app.get("/sort",function(req,res){
    ...
    var str="<html><head><style>a{margin:20px;} td{border:1px solid blue;}</style></head><body><a href='/sort'>sort</a><a href='/gender'>gender</a><a href='/show'>show</a><br/><form action='/sort' onchange='this.submit()' method='post'><input type='radio' name='ros' val='ros' checked>rosnaco<input type='radio' name='ros' value='mal'>malejaco</form><table>"
    tab.forEach(function(item,index){
        str+="<tr>"
